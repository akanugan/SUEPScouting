...

{
 ...
 if (doL1) {
  ...
  //l1tResultsTag_ = iConfig.getParameter<edm::InputTag>("l1tResults");
  //l1GtUtils_ = new l1t::L1TGlobalUtil(iConfig, consumesCollector(), *this, iConfig.getParameter<edm::InputTag>("l1tResults"), iConfig.getParameter<edm::InputTag>("l1tMenu"));
 }
 else {
...
//  Handle<double> rhoH;
 ...
 if (doL1) {
    //full L1 menu print
    // const std::vector<std::string>& algNames = l1GtUtils_->algoNames();
    // for (const auto& name : algNames) {
    //   std::cout << "Available L1 seed: " << name << std::endl;
    // }
    ...
    //   //cout << "l1Seeds_name: " << l1Seeds_[iseed] << " l1htbit_decision: " << l1htbit  << endl;
